...
const EditarEmpleado = () => {
    ...
    const actualizarEmpleado = async (e) => {
        ...
        const response = await APIImvoke.invokePUT(`/api/empleados/${id}`, {
            nombres: nombres,
            apellidos: apellidos,
            cargo: cargo,
            cedula: cedula,
        ...
        if(response){
            const msg = "Empleado actualizado correctamente."
            swal({
                title: 'Info',
                text: msg,
                icon: 'success',
            ...
            const msg = "No fue posible actualizar el empleado."
            swal({
                title: 'Error',
                text: msg,
                icon: 'error',
    ...
    const getEmpleadoId = async () => {
        const clientes = await APIImvoke.invokeGET(`/api/empleados/${id}`);
        setNombres(clientes.nombres);
        setApellidos(clientes.apellidos);
        setCargo(clientes.cargo);
